...
object TestingTags {
    ...
    const val ARRIVAL_INFO_ETA_INFO = "ARRIVAL_INFO_ETA_INFO"
    const val ARRIVAL_INFO_END_OF_LINE = "ARRIVAL_INFO_END_OF_LINE"
    const val ARRIVAL_INFO_NO_INFO ="ARRIVAL_INFO_NO_INFO"
